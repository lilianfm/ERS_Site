...
$smtpserver = 'mail.YOUR_DOMAIN_HERE';
# Mail port of the SMTP server. Usually 25
$port = 25;
# hosts allowed accessing this cgi
@referer = ('YOUR_DOMAIN_HERE','66.179.155.146','mail.YOUR_DOMAIN_HERE','66.179.155.161','localhost','127.0.0.1');

# this is the default Return address if no email was submitted by the form
$return_addr = 'YOUR_EMAIL_HERE';
